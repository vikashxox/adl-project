                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _infoRow(Icons.badge, 'Username', officer['username'] as String? ?? 'N/A'),
                        _infoRow(Icons.phone, 'Phone', officer['phone'] as String? ?? 'Not Provided'),
                        _infoRow(Icons.email_outlined, 'Email', officer['email'] as String? ?? 'Not Provided'),
                        _infoRow(Icons.location_city, 'District', officer['district'] as String? ?? 'Not Provided'),
                      ],
                    ),
                  ),
                  const SizedBox(height: 20),
